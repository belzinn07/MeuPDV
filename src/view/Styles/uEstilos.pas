...
const
  ...
  COR_FUNDO_CLARO        = $00FBF9F8;  // Fundo cinza bem claro (fundo da aplica��o)
  COR_FUNDO_BRANCO       = $00FFFFFF;  // Fundo de cards, pain�is e tabelas

  // Tipografia (Textos)
  COR_TEXTO_ESCURO       = $003D332D;  // Texto principal (quase preto)
  COR_TEXTO_CINZA        = $009B8E85;  // Texto secund�rio/labels/placeholders
  COR_TEXTO_BRANCO       = $00FFFFFF;  // Texto sobre fundos escuros

  // Elementos de UI (Bordas e �cones)
  COR_BORDA              = $00E9E3DF;  // Linhas divis�rias e bordas de inputs
  COR_ICONE_AZUL         = $00A5612E;  // Cor padr�o para �cones de a��o (mesmo azul prim�rio)
